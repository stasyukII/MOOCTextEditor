...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
			...
			
		{
			...
			String letsCheck = getStringFromFile(textfile,numToCheck);
				long timeStart = System.nanoTime();
				Document basicDoc= new BasicDocument(letsCheck);
				basicDoc.getFleschScore();
				long timeEnd = System.nanoTime();
				double whatTime = (timeEnd-timeStart)/1000000000.0;
			System.out.print(whatTime+"\t");
				long timeStart1 = System.nanoTime();
				Document effDoc= new EfficientDocument(letsCheck);
				effDoc.getFleschScore();
				long timeEnd1 = System.nanoTime();
				double whatTime1 = (timeEnd1-timeStart1)/1000000000.0;
			System.out.print(whatTime1+"\t");
			System.out.println("");
